...
public:
    ...
    Hero(std::string name) : _name(name), _xp(0), _level(1), _hp(10), _strength(2), _gold(0) {    // Constructor to load new hero into the database
    ...
    Hero(std::string name, int xp, int level, int hp, int strength, int gold) : _name(name), _xp(xp), _level(level), _hp(hp), _strength(strength), _gold(gold) {} // Constructor to edit existing hero
